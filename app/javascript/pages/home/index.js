      ...
      <Columns>
        <Columns.Column>
          <MainHeading className='has-text-weight-light has-text-centered has-text-white' size={1}>
            SEU APP DE <br /><span className='has-text-danger'>MÚSICA</span>
          </MainHeading>
        </Columns.Column>
      </Columns>
      ...
      <Columns className="has-text-centered">
        <Columns.Column>
          <a href='users/sign_up'>
            <ButtonSubscribe className='is-danger is-outlined is-large has-text-white'>CADASTRAR AGORA</ButtonSubscribe>
          </a>
        </Columns.Column>
      </Columns>
    </SectionWrapper>
